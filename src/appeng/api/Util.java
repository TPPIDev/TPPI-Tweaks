...
/**
 * Returns useful stuff of various sorts to access internal features and stuff,
 * the meat of the important stuff is accessed here...
 * 
 * Available IMCs: "AppliedEnergistics", "add-grindable",
 * "itemid,meta,itemid,meta,rotations" - AE uses the standard 8 for ores, 4 for
 * ingots. "AppliedEnergistics", "blacklist-cell" "itemid[,meta]"
...
public class Util
{
	...
	/**
	 * creates a new IMEInventoryUtil, only useful if you want to use the fancy
	 * get items by recipe functionaility.
	 * 
	 * @param ime
	...
	/**
	 * Gets the instance of the special comparison registry ( Bees / Trees )
	 * that sort of stuff
	 * 
	...
	/**
	 * Is it a IStorageCell, this will only return true for IStoreCells and not
	 * custom cells, you should probobly not use it unless you have a specific
	 * case.
	 */
	 ...
	 * 
	 * @param i
	 * @return only works with Basic Cells, not custom ones, suggested not to
	 *         use.
	 */
	...
	/**
	 * Lets you blast list a specific item from being stored in basic cells,
	 * this works on any mod cells that use IStorageCell as well.
	 * 
	 * @param ItemID
	 * @param Meta
	 */
