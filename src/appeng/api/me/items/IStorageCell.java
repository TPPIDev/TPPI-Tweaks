...
{
	/**
	 * rv0 - If this returns something where N % 8 != 0 Then you will be shot on
	...
	/**
	 * rv0 - Determines the number of bytes used for any type included on the
	 * cell.
	 * 
	 * @param cellItem
	 * @return numberOfBytes
	...
	/**
	 * rv11 - Must be between 1 and 63, indicates how many types you want to
	 * store on the item.
	 * 
	 * @param cellItem
	 ...
	 * if you don't care, just return false; As the handler for this type of
	 * cell is still the default cells, the normal AE black list is also
	 * applied.
	 * 
	 * @param cellItem
	...
	/**
	 * rv11 - allows you to specify if this storage cell can be stored inside
	 * other storage cells, only set this for special items like the matter
	 * cannon that are not general purpose storage.
	 * 
	 * @return
	 */
	...
	/**
	 * rv14 - allows an item to selectivly enable or disable its status as a
	 * storage cell.
	 * 
	 * @param i
	 * @return
