...
/**
 * Implemented by the ME Interface give direct access to some more complicated
 * logic, in a simpler way, was used for earily LP integration.
 */
public interface ITileInterfaceApi
{
	 ...
	 * @param i
	 * @param MaxNeeded
	 *            , a cut off where you stop caring
	 ...
	 *            , item to extract.
	 * @param doExtract
	 *            , if you don't its just a simulation.
