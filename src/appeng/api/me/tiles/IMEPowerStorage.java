...
public interface IMEPowerStorage
{
	...
	/**
	 * ME power storage asset, pass the amount you want to use, and what you
	 * want to use it for.
	 * 
	 * @param use
	 * @param for_what
	 ...
	 * 
	 * @param amt
	 *            that was not added to storage myEnergy = addMEPower( myEnergy
	 *            ); // pushes your power into the network.
	 * @return
	 */
	...
	/**
	 * Checked on network reset to see if your block can be used as a public
	 * power storage ( use getPowerFlow to control the behavior )
	 * 
	 * @return
	 */
	...
	/**
	 * Control the power flow by telling what the controller can do, either add?
	 * or subtract? or both!
	 * 
	 * @return
	 */
	...
	/**
	 * Drains power from this storage, it returns the power it was able to
	 * obtain.
	 * 
	 * @param amt
	 *            - amount of power to drain.
