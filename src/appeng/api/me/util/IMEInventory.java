...
public interface IMEInventory
{
	...
	/**
	 * The estimated number of additional items this inventory can hold,
	 * regardless of type.
	 */
	...
	/**
	 * Returns how many of this item are in the inventory, regardless of a how
	 * many stacks / cells or anything else.
	 */
	public long countOfItemType(IAEItemStack i);

	/**
	 * Adds input, to the inventory, and returns items not added, complete
	 * failure yields a copy of the stack that was passed.
	 */
	public IAEItemStack addItems(IAEItemStack input);

	/**
	 * Attempts to extract the requested item, in the count specified by the
	 * request, returns items extracted, complete failure yields NULL.
	 */
	...
	/**
	 * Returns a list of all available items, with stackSize set to the real
	 * amount, without stack limits.
	 */
	...
	/**
	 * Identical to addItems(...) but it don't change anything, its just a
	 * simulation. this is used when dealing with pipes/tubes, and routing.
	 */
