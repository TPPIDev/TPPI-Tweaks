...
public interface IMEInventoryHandler extends IMEInventory
{
	...
	/**
	 * Returns estimated number of total bytes represented by the inventory,
	 * used mainly for display.
	 */
	public long totalBytes();

	/**
	 * Returns estimated number of free bytes represented by inventory, used
	 * mainly for display.
	 */
	public long freeBytes();

	/**
	 * Returns number of used bytes represented by the inventory, used mainly
	 * for display.
	 */
	...
	/**
	 * This tells you where it found your cell, so if your cell changes, you
	 * should update this block...
	 */
