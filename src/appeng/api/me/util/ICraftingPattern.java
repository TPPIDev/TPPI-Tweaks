...
/**
 * this class can be implemented if you wish to implement a
 * TileCraftingProvider.
 */
public interface ICraftingPattern
{
	 ...
	 * 
	 * Example: sticks, will return a single stack of 2, rather then two stacks
	 * of 1. The same Item will not show more than one stack.
	 */
