...
/**
 * Interact with the internals of assembler patterns, get this via
 * Util.getAssemblerPattern(...)
 * 
...
public interface ICraftingPatternMAC extends ICraftingPattern
{
	...
	/**
	 * Encode a pattern. craftingMatrix - accepts a 3x3 grid of ItemStacks and
	 * Nulls. output - accepts a single ItemStack, NEVER SEND NULL
	 */
	...
	/**
	 * Returns a 3x3 matrix of nulls or ItemStacks, or null if it is not
	 * included.
	 */
	ItemStack[] getCraftingMatrix();

	/**
	 * Same as getCraftingMatrix(), but gets a crafting inventory for real
	 * crafting.
	 * 
	 * Item pool is optional, null will work, but it won't be able to edit
	 * items...
	 */
