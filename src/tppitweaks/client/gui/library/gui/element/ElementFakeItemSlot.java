...
{
    public ElementFakeItemSlot(GuiBase parent, int x, int y, ItemStack stack)
    {
        super(parent, x, y, stack);
    }

    public ElementFakeItemSlot(GuiBase parent, int x, int y, ItemStack stack, boolean big)
    {
