...
public class ConfigurationHandler
{
	...
	public static String[] am2MobKeys = { "EntityHecate", "EntityDarkMage", "EntityLightMage", "EntityEarthElemental", "EntityFireElemental", "EntityWisp", "EntityWaterElemental",
			"EntityManaElemental", "EntityDryad", "EntityManaCreeper", "EntityDarkling" };
	...
	public static void init(File file)
	{
		...
		ic2TEGlassInterchangeability = config.get("OPTIONS", "ic2TEGlassInterchangeability", true,
		...
		doPlatinumInCentrifuge = config.get("OPTIONS", "doPlatinumInCentrifuge", true, "Re-adds the old GregTech centrifuge recipe for platinum dust to iridium nugget + small nickel dust.")
				.getBoolean(true);
		...
		tinkersAluminumPlates = config.get("OPTIONS", "tinkersAluminumPlates", true, "Tinkers' Construct aluminum ingots can make aluminum plates in the GregTech plate bending machine.").getBoolean(
				true);
