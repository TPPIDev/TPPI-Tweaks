...
public class EnderStorageTweaks extends TweakingRegistry
{
    ...
    {
        ItemStack reinforcedTank = new ItemStack(ModBlocks.teTank, 1, 4);
        ItemStack resonantChest = new ItemStack(ModBlocks.teStrongbox, 1, 4);
        ItemStack resonantSatchel = new ItemStack(ModItems.teSatchel, 1, 4);
